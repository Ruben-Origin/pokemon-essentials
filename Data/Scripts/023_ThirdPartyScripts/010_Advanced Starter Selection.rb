...
# * Compatibility for v18 by Bhagya Jyoti
#
# Current Version: V1.0
# 
# PokemonStarterSelection.new(3,6,9)
#
#===============================================================================
class PokemonStarterSelection
 ...
 def initialize(pkmn1,pkmn2,pkmn3)
  ...
  @sprites["black"].setBitmap("Graphics/Pictures/AdvancedStarter/black")
  @sprites["black"].opacity=0
  
  @sprites["bg"]=IconSprite.new(0,0,@viewport)    
  @sprites["bg"].setBitmap("Graphics/Pictures/AdvancedStarter/bg")
  @sprites["bg"].opacity=0
  
  @sprites["ball_1"]=IconSprite.new(0,0,@viewport)
  @sprites["ball_1"].setBitmap("Graphics/Pictures/AdvancedStarter/ball1")
  @sprites["ball_1"].x=90
  @sprites["ball_1"].y=154
  @sprites["ball_1"].opacity=0
  
  @sprites["ball_2"]=IconSprite.new(0,0,@viewport)
  @sprites["ball_2"].setBitmap("Graphics/Pictures/AdvancedStarter/ball2")
  @sprites["ball_2"].x=206
  @sprites["ball_2"].y=147
  @sprites["ball_2"].opacity=0
      
  @sprites["ball_3"]=IconSprite.new(0,0,@viewport)
  @sprites["ball_3"].setBitmap("Graphics/Pictures/AdvancedStarter/ball3")
  @sprites["ball_3"].x=330
  @sprites["ball_3"].y=151
  @sprites["ball_3"].opacity=0
  
  @sprites["select"]=IconSprite.new(0,0,@viewport)
  @sprites["select"].setBitmap("Graphics/Pictures/AdvancedStarter/select")
 ...
 def pressBall
  ...
  @sprite.visible=true
  pbPlayCrySpecies(@pkmn_array[@select-1])
  pbWait(20)
